...
public class ServerFingerprintTests : ReadFileTestBase
{
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsHexSha256()
    {
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsHexSha256WithAltercations()
    {
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsSha256()
    {
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsMD5()
    {
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsMD5ToLower()
    {
    ...
    [Test]
    public void ReadFile_TestTransferWithExpectedServerFingerprintAsMD5Hash()
    {
    ...
    public void ReadFile_TestThrowsTransferWithInvalidExpectedServerFingerprintAsMD5()
    {
        ...
        var ex = Assert.Throws<SshConnectionException>(() => SFTP.ReadFile(_input, _connection));
