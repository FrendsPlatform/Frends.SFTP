...
public class ServerFingerprintTests : RenameFileTestBase
{
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsHexSha256()
    {
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsHexSha256WithAltercations()
    {
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsSha256()
    {
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsMD5()
    {
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsMD5ToLower()
    {
    ...
    [Test]
    public void RenameFile_TestTransferWithExpectedServerFingerprintAsMD5Hash()
    {
    ...
    public void RenameFile_TestThrowsTransferWithInvalidExpectedServerFingerprintAsMD5()
    {
        ...
        var ex = Assert.Throws<SshConnectionException>(() => SFTP.RenameFile(_input, _connection));
